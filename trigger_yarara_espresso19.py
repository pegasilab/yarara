...
if stage==1:
    ...
    sts.import_rv_dace(ins,calib_std=0.3,bin_length=bin_length, drs_version=drs_version)
...
if nb<=0:#15
    ...
    if stage<11:
        stage = 11
        print(' [INFO] Not enough observations for the pipeline reduction, directly jump to stage 11')
...
if stage==11:
    ...
    sts.yarara_correct_mad(sub_dico=sub_dico,
                           continuum='linear',
                           k_sigma = 2,
                           k_mad = 2,
                           n_iter = 1,
...
if stage==32:
    ...
    vec_shell_all = sts.import_ccf_timeseries('LBL_ITER_kitcat_mask_'+sts.starname,'matching_shell7','rv')    
    ...
    if sts.starname!='Sun':
        ...
        for i,v in enumerate([vec_ref, vec_lbl, vec_lbl2, vec_shell, vec_shell_all, vec_color]):
    ...
    for name,v in zip(['drs','yarara_v1_lbl','yarara_v2_lbl','yarara_shell','yarara_shell7','yarara_color'],[vec_ref, vec_lbl, vec_lbl2, vec_shell, vec_shell_all, vec_color]):
...
if stage==33:
    ...
    for name,v in zip(['_v1','_v2','_shell','_shell7','_color'],[vec_lbl, vec_lbl2, vec_shell, vec_shell_all, vec_color]):
    ...
    sts.yarara_plot_all_rv('LBL_kitcat_mask_'+sts.starname, v2_dico, ofac=10, photon_noise=0.4, deg_detrending=2, p_min=0, method='tree')
