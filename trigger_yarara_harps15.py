...
if stage==3:
    ...
    if False: #no fringing correction on HARPS15
        if reference is None:
...
if stage==11:
    ...
    sts.yarara_correct_frog(correction = 'thar',
                            ...
                            reference = ref,
                            berv_shift='berv', wave_max_train=4100, pca_comp_kept=2, treshold_contam=1, equal_weight=True, complete_analysis=False, rcorr_min=0.4)
...
if stage==12:
    #CORRECT CONTINUUM     
    if reference is None:
        sts.yarara_median_master(sub_dico = 'matching_thar', 
                                 continuum = 'linear',
                                 supress_telluric=False,
                                 method = 'mean' #if smt else than max, the classical weighted average of v1.0
                                 )
    
    sts.yarara_correct_smooth(sub_dico='matching_thar',
                           continuum='linear',
                           reference=ref,
                           window_ang = 5)
...
if stage==26:
    ...
    sts.lbl_polar_1year(kw_dico='lbl',sub_dico='matching_mad') 
    sts.lbl_polar_1year(kw_dico='lbl_iter',sub_dico='matching_mad') 
