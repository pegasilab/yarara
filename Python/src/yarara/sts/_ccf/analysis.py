...
def yarara_ccf(
    ...
    for j, i in enumerate(files):
        ...
        if save:
            ...
            iofun.pickle_dump(file, open(i, "wb"))
    ...
    if not os.path.exists(self.directory + "Analyse_ccf.p"):
        ...
        iofun.pickle_dump(ccf_summary, open(self.directory + "/Analyse_ccf.p", "wb"))
    ...
    if save:
        ...
        iofun.pickle_dump(file_summary_ccf, open(self.directory + "/Analyse_ccf.p", "wb"))
