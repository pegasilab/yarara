...
if stage == 5:
    ...
    if nb_spec:
        ...
        sts.yarara_produce_mask_contam(
...
if stage == 51:  # form the database for the slice master production
    ...
    plt.savefig(
        sts.dir_root + "IMAGES/PCA_%s_%s_%s.png" % (sub_dico2, sts.starname, spec)
    )
...
if False:
    ...
    vec_ccf = sts.import_ccf_timeseries(
        "CCF_kitcat_mask_" + sts.starname, "matching_CaWCaY", "rv"
    )
    vec_ref = sts.import_dace_sts()
